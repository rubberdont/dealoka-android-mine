...
public class Home extends FragmentActivity {
	...
	private ImageButton btn_special_code;
	...
	private void setInitial() {
		...
		btn_special_code = (ImageButton)findViewById(R.id.btn_special_code);
		setEventListener();
	...
	private void setEventListener() {
		...
		btn_special_code.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				doSpecialCode();
			}
	...
	private void doSpecialCode() {
		GlobalController.openSpecialCode(Home.instance);
	}
